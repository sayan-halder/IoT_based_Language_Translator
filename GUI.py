...
def language():
    ...
    with mc as source:
        ...
        try:
            ...
            v2.set("Speech to be Translated: "+str(get_sentence))
            root.update()
            ...
            v3.set("Translated Speech: "+str(text))
            root.update()
...
button1 = tk.Button(root, text = "Convert", command = language).place(relx = 0.05, rely = 0.26)

button2 = tk.Button(root, text = "Clear", command = clear).place(relx = 0.3, rely = 0.26)
